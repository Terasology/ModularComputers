...
public class ItemCountMethod extends AbstractModuleMethodExecutable<Object> {
    ...
    public ItemCountMethod(String methodName) {
        super("Checks how many items are in the specified inventory's slot.", "Number",
                "Number of items in the specified slot in the inventory.");
        ...
        addExample("This example creates output inventory binding to an inventory above it and prints out number of items in its first " +
                        "slot. Please make sure " +
                ...
                "var invBind = computer.bindModuleOfType(\"" + InventoryModuleCommonSystem.COMPUTER_INVENTORY_MODULE_TYPE + "\");\n" +
                        ...
                        "console.append(\"Inventory above has \" + invBind.getItemCount(topInv, 0) + \" number of items in its first " +
                        "output slot.\");");
    }
