...
public class InventorySlotCountMethod extends AbstractModuleMethodExecutable<Object> {
    ...
    public InventorySlotCountMethod(String methodName) {
        ...
        addExample("This example creates output inventory binding to an inventory above it and prints out the slot count for it. Please " +
                        "make sure this computer has a module of Inventory Manipulator type in any of its slots.",
                "var invBind = computer.bindModuleOfType(\"" + InventoryModuleCommonSystem.COMPUTER_INVENTORY_MODULE_TYPE + "\");\n" +
                        ...
                        "console.append(\"Inventory above has \" + invBind.getInventorySlotCount(topInv) + \" number of slots available " +
                        "for output.\");"
        );
    }
