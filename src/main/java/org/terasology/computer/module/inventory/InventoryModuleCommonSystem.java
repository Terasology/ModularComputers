    ...
    public void preBegin() {
        if (moduleConfigManager.getBooleanVariable("ModularComputers", "registerModule.inventory", true)) {
            computerLanguageRegistry.registerObjectType(
                    "InventoryBinding",
                    Collections.singleton(HTMLLikeParser.parseHTMLLikeParagraph(null, "An object that tells a method how to access an " +
                            "inventory. Usually used as a parameter for methods in Inventory Manipulator computer module. " +
                            "This object comes in two types defined upon creation:<l>" +
