...
public class DestroyToInventoryFunction implements ModuleFunctionExecutable {
    private WorldProvider worldProvider;
    private BlockEntityRegistry blockEntityRegistry;

    public DestroyToInventoryFunction(WorldProvider worldProvider, BlockEntityRegistry blockEntityRegistry) {
