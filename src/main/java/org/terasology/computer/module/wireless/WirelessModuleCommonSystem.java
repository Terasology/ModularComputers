...
public class WirelessModuleCommonSystem extends BaseComponentSystem implements UpdateSubscriberSystem {
    ...
    private final CommunicationChannels<EntityRef> communicationChannels = new CommunicationChannels<>();
    @In
        ...
        if (moduleConfigManager.getBooleanVariable("ModularComputers", "registerModule.wireless", true)) {
            computerLanguageRegistry.registerObjectType(
                    ...
                    Collections.singleton(HTMLLikeParser.parseHTMLLikeParagraph(null, "An object that tells a method " +
                            "how to access a communication channel. This object " +
            ...
            int maxMessageExpiry = moduleConfigManager.getIntVariable("ModularComputers", "wireless.maxMessageExpiry"
                    , 5000);
            int maxMessageLength = moduleConfigManager.getIntVariable("ModularComputers", "wireless.maxMessageLength"
                    , 1024);
