...
public class ConsumeMessageMethod extends AbstractModuleMethodExecutable<Object> {
    ...
    public ConsumeMessageMethod(String methodName, Time time) {
        super("Consumes next message from the specified communication channel.", "Map",
                "Returns a map with two keys - \"message\" that has a value type of String and contains message sent and " +
