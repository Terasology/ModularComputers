...
public class BindModuleFunction extends TerasologyFunctionExecutable {
    public BindModuleFunction() {
        super("Binds the module specified in the slot number.", "Object",
                "Binding to the module. This object exposes all the methods, as described in documentation for the " +
                        "module.");

        addParameter("slot", "Number", "Slot number of a module to bind.");

        addExample("This example binds module in the first slot and executes \"move\" method on it with \"up\" " +
                        "parameter. " +
                        "In order for successful execution - please place \"Mobility\" module in the first slot of " +
                        "the computer.",
